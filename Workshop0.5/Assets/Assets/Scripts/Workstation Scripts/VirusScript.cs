...
public class VirusScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (virusSprite.enabled)
            transform.Find("Green Light").GetComponent<SpriteRenderer>().enabled = true;
        else
            transform.Find("Green Light").GetComponent<SpriteRenderer>().enabled = false;

        if (docSprite.enabled)
            transform.Find("Red Light").GetComponent<SpriteRenderer>().enabled = true;
        else
            transform.Find("Red Light").GetComponent<SpriteRenderer>().enabled = false;
    }
}
